...
<br><img src="https://github.com/user-attachments/assets/bdddb985-46bf-4fce-995b-e0bbb86c779f" alt="Book Cover" width="75" height="125" style="margin-left: 100px;">
 </ul>
...
### Transferred
<p style="color: black; font-family: 'Futura', serif; font-size: 16px;">
1. <b>PhD</b> in Mechanical Engineering - Geroge Washington University, DC, USA (Transferred to University of Maryland, College Park, MD USA)</p>
<p style="color: black; font-family: 'Futura', serif; font-size: 16px; padding-left: 16px;">
 </p>
<p style="color: black; font-family: 'Futura', serif; font-size: 16px;">
2. <b>PhD</b> in Mechanical Engineering - University of Toronto, Canada (Transferred to George Washington Univerity, USA)</p>
<p style="color: black; font-family: 'Futura', serif; font-size: 16px; padding-left: 16px;">
...
<section style="font-family: 'Futura', serif; color: black;">
  <h3 style="font-size: 18px; font-weight: bold;">Book:</h3>
  ...
  <h4 style="font-size: 16px; font-weight: bold;">Global Availability:</h4>
  <a href="book.md" style="color: #0073e6; text-decoration: none;">Book Page</a>
</section>
